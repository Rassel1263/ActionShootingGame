//-----------------------------------------------------------------------------
// File: ActionShootingGame.cpp
//
// Desc: Better than just lights and materials, 3D objects look much more
//       convincing when texture-mapped. ActionShootingGame can be thought of as a sort
//       of wallpaper, that is shrinkwrapped to fit a texture. ActionShootingGame are
//       typically loaded from image files, and D3DX provides a utility to
//       function to do this for us. Like a vertex buffer, ActionShootingGame have
//       Lock() and Unlock() functions to access (read or write) the image
//       data. ActionShootingGame have a width, height, miplevel, and pixel format. The
//       miplevel is for "mipmapped" ActionShootingGame, an advanced performance-
...
//
//       ActionShootingGame are associated with geometry through texture coordinates.
...
INT WINAPI wWinMain(HINSTANCE hInst, HINSTANCE, LPWSTR, INT)
{
    ...
    HWND hWnd = CreateWindow(L"D3D Tutorial", L"D3D Tutorial 05: ActionShootingGame",
